...
public class CustomIntegerArrayList {
    ...
    public void remove(int num, int element) {
        // TODO Implement method
        for (int i =0;i<num;i++)
            if (this.arr.contains(element))
                this.arr.remove(this.arr.indexOf(element));
    }
    ...
    public ArrayList<Integer> splice(int index, int num) {
        ...
        for (int i = 0;i< index;i++){left.add(this.arr.get(i));}
        for (int j = num + index;j<this.arr.size();j++){right.add(this.arr.get(j));}
        for (int item : left){finalArrayList.add(item);}
        for (int item3 : right){finalArrayList.add(item3);}
        // TODO Implement method
        this.arr = finalArrayList;
    ...
    public ArrayList<Integer> splice(int index, int num, int[] otherArray) {
        ...
        for (int j = num + index;j<this.arr.size();j++){right.add(this.arr.get(j));}
        for (int item : left){finalArrayList.add(item);}
        for (int item2: otherArray){finalArrayList.add(item2);}
        for (int item3 : right){finalArrayList.add(item3);}
        // TODO Implement method
        this.arr = finalArrayList;
        return finalArrayList;
